...
curl -z CH32V003DS0.PDF -o CH32V003DS0.PDF https://file.wch.cn/download/file?id=408
# https://www.wch.cn/downloads/CH32V003RM_PDF.html
curl -z CH32V003RM.PDF -o CH32V003RM.PDF https://file.wch.cn/download/file?id=411
cd ..

# https://www.wch.cn/downloads/CH32V003EVT_ZIP.html
curl -z CH32V003EVT.ZIP -o CH32V003EVT.ZIP https://file.wch.cn/download/file?id=409
rm -rfv EVT
unzip -O GB2312 *.ZIP
